 ...
 * @property fecha Fecha límite o de entrega de la tarea (formato: dd/MM/yyyy).
...
data class TareaModelo(
    ...
    var tipo: String = "Tarea",     // Ejemplo: "Tarea" o "Examen"
    var prioridad: String = "Baja"  // Ejemplo: "Alta", "Media" o "Baja"
)
